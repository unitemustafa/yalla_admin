...
const pageKeys: Record<PageKey, TranslationKey> = {
  ...
  "home-campaigns": "page.homeCampaigns",
  "create-home-campaign": "page.createHomeCampaign",
  cities: "page.cities",
  "delivery-zone": "page.deliveryZone",
  "shipping-companies": "page.shippingCompanies",
  couriers: "page.couriers",
  "create-courier": "page.createCourier",
  customers: "page.customers",
  partners: "page.partners",
  "archived-items": "page.archivedItems",
  "archived-shops": "page.archivedShops",
  "archived-offers": "page.archivedOffers",
  "archived-cities": "page.archivedCities",
  "archived-delivery-zones": "page.archivedDeliveryZones",
