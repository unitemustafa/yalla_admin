  ...
  return (
    <Modal title="تغيير كلمة المرور" maxWidth="max-w-md">
      <div className="space-y-4 p-5">
        <div className="rounded-lg border bg-muted/30 px-4 py-3"><div className="text-xs text-muted-foreground">الطيار</div><div className="mt-1 font-bold">{fullNameFromBackendUser(courier)}</div></div>
